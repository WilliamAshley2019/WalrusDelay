...
private:
    ...
    juce::ToggleButton tapeDelayOnOffButton, reverbOnOffButton;
    ...
    juce::Label tapeDelayOnOffLabel, reverbOnOffLabel;
    ...
    std::unique_ptr<ButtonAttachment> tapeDelayOnOffAttachment, reverbOnOffAttachment;
